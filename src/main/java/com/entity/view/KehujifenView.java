 ...
 */
@TableName("kehujifen")
public class KehujifenView extends KehujifenEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 增加类型的值
		*/
		private String kehujifenValue;
	...
	public KehujifenView() {

	}

	public KehujifenView(KehujifenEntity kehujifenEntity) {
		try {
			BeanUtils.copyProperties(this, kehujifenEntity);
			...
			* 获取： 增加类型的值
			*/
			public String getKehujifenValue() {
				return kehujifenValue;
			}
			/**
			* 设置： 增加类型的值
			*/
			public void setKehujifenValue(String kehujifenValue) {
				this.kehujifenValue = kehujifenValue;
			}
