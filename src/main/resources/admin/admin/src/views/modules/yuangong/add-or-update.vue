        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否禁用" prop="jinyongTypes">
                        <el-select v-model="ruleForm.jinyongTypes" :disabled="ro.jinyongTypes" placeholder="请选择是否禁用">
                            <el-option
