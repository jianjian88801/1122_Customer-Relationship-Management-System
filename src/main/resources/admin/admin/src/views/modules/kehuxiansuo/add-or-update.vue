    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="姓名" prop="kehuxiansuoName">
                       <el-input v-model="ruleForm.kehuxiansuoName"
                                 placeholder="姓名" clearable  :readonly="ro.kehuxiansuoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="姓名" prop="kehuxiansuoName">
                           <el-input v-model="ruleForm.kehuxiansuoName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="kehuxiansuoPhone">
                       <el-input v-model="ruleForm.kehuxiansuoPhone"
                                 placeholder="手机号" clearable  :readonly="ro.kehuxiansuoPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="手机号" prop="kehuxiansuoPhone">
                           <el-input v-model="ruleForm.kehuxiansuoPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身份证号" prop="kehuxiansuoIdNumber">
                       <el-input v-model="ruleForm.kehuxiansuoIdNumber"
                                 placeholder="身份证号" clearable  :readonly="ro.kehuxiansuoIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="身份证号" prop="kehuxiansuoIdNumber">
                           <el-input v-model="ruleForm.kehuxiansuoIdNumber"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kehuxiansuoPhoto" label="照片" prop="kehuxiansuoPhoto">
                        <file-upload
                            tip="点击上传照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.kehuxiansuoPhoto?ruleForm.kehuxiansuoPhoto:''"
                            @change="kehuxiansuoPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kehuxiansuoPhoto" label="照片" prop="kehuxiansuoPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.kehuxiansuoPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="kehuxiansuoEmail">
                       <el-input v-model="ruleForm.kehuxiansuoEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.kehuxiansuoEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="电子邮箱" prop="kehuxiansuoEmail">
                           <el-input v-model="ruleForm.kehuxiansuoEmail"
                                     placeholder="电子邮箱" readonly></el-input>
                       </el-form-item>
                   </div>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="线索类型" prop="kehuxiansuoTypes">
                        <el-select v-model="ruleForm.kehuxiansuoTypes" :disabled="ro.kehuxiansuoTypes" placeholder="请选择线索类型">
                            <el-option
                                v-for="(item,index) in kehuxiansuoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="线索类型" prop="kehuxiansuoValue">
                        <el-input v-model="ruleForm.kehuxiansuoValue"
                            placeholder="线索类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="线索详情" prop="kehuxiansuoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kehuxiansuoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kehuxiansuoContent" label="线索详情" prop="kehuxiansuoContent">
                            <span v-html="ruleForm.kehuxiansuoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    kehuxiansuoName: false,
                    kehuxiansuoPhone: false,
                    kehuxiansuoIdNumber: false,
                    kehuxiansuoPhoto: false,
                    sexTypes: false,
                    kehuxiansuoEmail: false,
                    kehuxiansuoTypes: false,
                    kehuxiansuoContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                ...
                rules: {
                   ...
                   kehuxiansuoContent: [
                              { required: true, message: '线索详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kehuxiansuo_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kehuxiansuoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`kehuxiansuo/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kehuxiansuoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            kehuxiansuoPhotoUploadChange(fileUrls){
                this.ruleForm.kehuxiansuoPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
