               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="kehuEmail">
                       <el-input v-model="ruleForm.kehuEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.kehuEmail"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分" prop="kehuJifenNumber">
                       <el-input v-model="ruleForm.kehuJifenNumber"
                                 placeholder="积分" clearable  :readonly="ro.kehuJifenNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="客户详细介绍" prop="kehuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kehuContent" label="客户详细介绍" prop="kehuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kehuContent: [
                              { required: true, message: '客户详细介绍不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
